...
exec_list = make_exec_list(exec_tracking, exec_visualization, exec_detection)
...
while True:
    try:
        ...
        if 'pcl_from_rangeimage' in exec_list:
            ...
            lidar_pcl = load_object_from_file(results_fullpath+"/results_sequence_1_resnet", data_filename, 'lidar_pcl', cnt_frame)
        ...
        if 'bev_from_pcl' in exec_list:
            ...
            lidar_bev = load_object_from_file(results_fullpath+"/results_sequence_1_resnet", data_filename, 'lidar_bev', cnt_frame)
        ...
        if (configs_det.use_labels_as_objects==True):
            ...
            if 'detect_objects' in exec_list:
                ...
                if 'perform_tracking' in exec_list:
                    ...
                    detections = load_object_from_file(results_fullpath+"/results_sequence_1_resnet", data_filename, 'detections_' + configs_det.arch + '_' + str(configs_det.conf_thresh), cnt_frame)
        ...
        if 'validate_object_labels' in exec_list:
            ...
            valid_label_flags = load_object_from_file(results_fullpath+"/results_sequence_1_resnet", data_filename, 'valid_labels', cnt_frame)            
        ...
        if 'measure_detection_performance' in exec_list:
            ...
            # load different data for final project vs. mid-term project
            if 'perform_tracking' in exec_list:
                det_performance = load_object_from_file(results_fullpath+"/results_sequence_1_resnet", data_filename, 'det_performance_' + configs_det.arch + '_' + str(configs_det.conf_thresh), cnt_frame)
            else:
                det_performance = load_object_from_file(results_fullpath+"/results_sequence_1_resnet", data_filename, 'det_performance_' + configs_det.arch + '_' + str(configs_det.conf_thresh), cnt_frame)   
        ...
        if 'show_range_image' in exec_list:
            ...
            cv2.imwrite('./result_image/range_image.png', img_range)
